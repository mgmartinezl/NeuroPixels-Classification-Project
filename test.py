...
data_sets = [
    ...
    # 'F:/data/GoC/19-11-11_YC040/19-11-11_YC040_probe2',  # GOOD
...
for dp in data_sets:
    ...
    routines_mem = f'C:/routinesMem/{sample_probe}/routinesMemory'
    ...
    for unit in good_units:
        ...
        if spikes_unit_20 != 0 and spikes_unit_20 > spikes_threshold:
            ...
            paths = [f"Images/Pipeline/Sample_{sample}/GoodUnits/Files",
                     f"Images/Pipeline/Sample_{sample}/GoodUnits/Images",
                     f"Images/Pipeline/Sample_{sample}/BadUnits/Files",
                     f"Images/Pipeline/Sample_{sample}/BadUnits/Images"
                     ]
