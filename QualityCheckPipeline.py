...
# Sample for testing
dp = 'F:/data/PkC/18-08-30_YC002/18-08-30_YC002_probe1'
sample = dp[12:26]
cell_type = dp[8:11]
...
# YC002 >> F:/data/PkC/18-08-30_YC002/18-08-30_YC002_probe1
good_units = [8, 10, 12, 16, 19, 21, 22, 24, 26, 27, 30, 31, 35, 36, 37, 38, 39, 41, 42, 50, 51, 54, 59, 60, 65, 70,
              72, 74, 78, 80, 84, 86, 94, 95, 97, 100, 102, 103, 104, 105, 106, 107, 108, 109, 111, 112, 116,
              117, 118, 120, 121, 122, 123, 124, 125, 126, 127, 129, 130, 132, 133, 136, 137, 138, 139,
              140, 142, 143, 144, 147, 148, 149, 151, 152, 153, 154, 155, 157, 158, 159, 163, 164, 165,
              168, 169, 170, 171, 173, 180, 205, 206, 210, 231, 237, 255, 256, 272, 275, 309, 316, 321,
              327, 330]
...
for unit in good_units:
    ...
    if spikes_unit_20 != 0 and spikes_unit_20 > spikes_threshold:
        ...
        paths = [f"Images/Pipeline/Sample_{sample}/QualityCheck/GoodUnits/Files",
                 f"Images/Pipeline/Sample_{sample}/QualityCheck/GoodUnits/Images"]
