...
GrC_Responsive = [
        ...
        '19-08-14_YC015-722',
        '19-08-14_YC015-680',
        '19-08-14_YC015-850',  # No responsive
        '19-08-14_YC016-1013',
        '19-08-14_YC016-640'
]
...
# Fix neg_decay_time
df['wf_NegDecayTime'] = np.abs(df['wf_NegDecayTime'])

# Get dummy variables from responsiveness
df = pd.get_dummies(df, columns=['ResponsiveUnit'])
# print(df.columns)
# df = df.drop(df['ResponsiveUnit_-1'])

df.to_csv("Neuropixels_FeaturesWithNonQualResponsiveUnits.csv", index=False)
